 ...
 * XPAR redefines
 */
#define DYNCLK_BASEADDR 		XPAR_VID_OUT_AXI_DYNCLK_0_S_AXI_LITE_BASEADDR
#define VDMA_ID 				XPAR_AXIVDMA_0_DEVICE_ID
#define HDMI_OUT_VTC_ID 		XPAR_VID_OUT_V_TC_0_DEVICE_ID
#define HDMI_IN_VTC_ID 			XPAR_VID_IN_V_TC_0_DEVICE_ID
#define HDMI_IN_GPIO_ID 		XPAR_VID_IN_AXI_GPIO_VIDEO_DEVICE_ID
#define HDMI_IN_VTC_IRPT_ID 	XPAR_FABRIC_VID_IN_V_TC_0_IRQ_INTR
#define HDMI_IN_GPIO_IRPT_ID 	XPAR_FABRIC_VID_IN_AXI_GPIO_VIDEO_IP2INTC_IRPT_INTR
