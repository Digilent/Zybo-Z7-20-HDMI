...
set wr_clock  [get_clocks -of_objects [get_ports vid_io_in_clk]]
set rd_clock  [get_clocks -of_objects [get_ports aclk]]
...
set_false_path -through [get_ports vid_io_in_reset] -to [get_pins -hierarchical -filter {NAME =~ */COUPLER_INST/FIFO_INST/inst_fifo_gen/gconvfifo.rf/grf.rf/*rstblk*/*PRE*}]
