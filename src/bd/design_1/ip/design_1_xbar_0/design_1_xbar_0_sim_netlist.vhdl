...
architecture STRUCTURE of design_1_xbar_0_axi_data_fifo_v2_1_10_ndeep_srl is
  ...
  attribute SOFT_HLUTNM of \gen_primitive_shifter.gen_srls[0].srl_inst_i_5\ : label is "soft_lutpair164";
  attribute SOFT_HLUTNM of \gen_primitive_shifter.gen_srls[0].srl_inst_i_6\ : label is "soft_lutpair164";
...
addr_arbiter_ar: entity work.design_1_xbar_0_axi_crossbar_v2_1_12_addr_arbiter
     port map (
      ...
      active_target_hot(0) => active_target_hot(0),
      aresetn_d => aresetn_d,
      \gen_arbiter.m_target_hot_i_reg[1]_0\(0) => addr_arbiter_ar_n_7,
...
\gen_master_slots[1].reg_slice_mi\: entity work.design_1_xbar_0_axi_register_slice_v2_1_11_axi_register_slice_1
     port map (
      ...
      \s_axi_araddr[30]\(0) => addr_arbiter_ar_n_7,
      s_axi_arvalid(0) => s_axi_arvalid(0),
      s_axi_bready(0) => s_axi_bready(0),
      \s_axi_bvalid[1]\ => \^s_axi_bvalid[1]\,
      s_axi_rlast(0) => s_axi_rlast(0),
...
entity design_1_xbar_0_axi_crossbar_v2_1_12_axi_crossbar is
  ...
  attribute C_M_AXI_ADDR_WIDTH of design_1_xbar_0_axi_crossbar_v2_1_12_axi_crossbar : entity is 30;
